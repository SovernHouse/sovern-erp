  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6 text-center py-12">
        <p className="text-slate-600">Claim information and investigation notes</p>
      </div>

      <ChatterPanel entityType="Claim" entityId={id} />
