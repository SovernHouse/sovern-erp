...
- **Latest commits on main (newest first):**
  - `<pending-commit>` fix(ai): Phase 4.16.1 — bump IDLE_TIMEOUT_MS 30s → 120s — local 602/602 green
