...
- **Latest commits on main (newest first):**
  - `<pending-commit>` feat(ai-mcp): Phase 4.16.3 — widen create_product MCP surface (4 columns + free-form specs merge advertised in schema) — local 607/607 green
