...
- **Latest commits on main (newest first):**
  - `<pending-commit>` fix(ai): Phase 4.16.2 — switch claude -p to stream-json so heartbeat sees per-event stdout — local 607/607 green
