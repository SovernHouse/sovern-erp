...
- **Latest commits on main (newest first):**
  - `<pending-commit>` feat(ai): Phase 4.16 — SSE streaming + heartbeat-based subprocess liveness — local 600/600 green
