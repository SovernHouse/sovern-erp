...
- **Latest commits on main (newest first):**
  - `<pending-commit>` fix(schema): Phase 4.17 follow-up — drop orphan FK from ProductAttribute + patch migration plural-table bug
