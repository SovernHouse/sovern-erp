...
- **Latest commits on main (newest first):**
  - `<pending-commit>` feat(approval): Phase 4.17 — Product approval modal + 3 endpoints + handler-noise gate — local 619/619 green
